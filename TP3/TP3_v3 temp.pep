 ...
 main:   NOP0
     ...
     CALL   LirChain
     LDA   0,s
     STA   nblet,d  ; Nombre de lettre de la chaÃ®ne
     ADDSP  2,i
...
;--------- Inserer
 ...
 InsMot:  .EQUATE 8 ; Mot Ã  insÃ©rer
 ...
 InsCrN: NOP0   ; On cree un nouveau noeud
  ...
  CALL new
  ADDSP 2,i
  LDA InsMot,s ; Le noeud est situÃ© Ã  InsTemp
  DECO InsTemp,s
  CHARO ' ',i
  DECO InsTemp,sf
  STA  InsTemp,sf
 ...
 InsCmp: LDA InsMot,s
  ...
  STA -4,s
  SUBSP 6,i
  CALL compare  ; On compare le mot Ã  la racine
  LDA 0,s
  ADDSP 2,i
  BREQ InsInc
  BRGT InsGT
 ...
 InsInc: LDX 2,i  ; On incrÃ©mente le nb d'occurences
  LDA InsRac,sxf
  ADDA 1,i
  STA InsRac,sxf
  BR InsFin

 InsLT: LDA InsMot,s ; Si le mot est plus petit, on vÃ©rifie avec le mot
  STA -4,s  ; Ã  la gauche de la racine
  LDX 4,i
  LDA InsRac,sxf
  STA -2,s
  SUBSP 4,i
 ...
 InsGT: LDA InsMot,s ; Si le mot est plus grand, on vÃ©rifie avec le mot
  STA -4,s  ; Ã  la droite de la racine
  LDX 6,i
  LDA InsRac,sxf
  STA -2,s
  SUBSP 4,i
